 ...
 */
abstract class Business implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\App\\Propel\\Map\\BusinessTableMap';
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildProduct> Collection to store aggregation of ChildProduct objects.
     */
    ...
    /**
     * Initializes internal state of App\Propel\Base\Business object.
     */
    ...
    /**
     * Compares this with another <code>Business</code> instance.  If
     * <code>obj</code> is an instance of <code>Business</code>, delegates to
     * <code>equals(Business)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setBusinessId($v)
    {
        ...
        if ($this->business_id !== $v) {
            $this->business_id = $v;
            $this->modifiedColumns[BusinessTableMap::COL_BUSINESS_ID] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[BusinessTableMap::COL_USER_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[BusinessTableMap::COL_NAME] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[BusinessTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setSector($v)
    {
        ...
        if ($this->sector !== $v) {
            $this->sector = $v;
            $this->modifiedColumns[BusinessTableMap::COL_SECTOR] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BusinessTableMap::translateFieldName('BusinessId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->business_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BusinessTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BusinessTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BusinessTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : BusinessTableMap::translateFieldName('Sector', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sector = (null !== $col) ? (string) $col : null;
            ...
            return $startcol + 5; // 5 = BusinessTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Propel\\Business'), 0, $e);
        }
    }
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildBusinessQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see Business::setDeleted()
     * @see Business::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBusinessQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BusinessTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(BusinessTableMap::COL_BUSINESS_ID)) {
            $modifiedColumns[':p' . $index++]  = 'business_id';
        }
        if ($this->isColumnModified(BusinessTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }
        if ($this->isColumnModified(BusinessTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(BusinessTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(BusinessTableMap::COL_SECTOR)) {
            $modifiedColumns[':p' . $index++]  = 'sector';
        }

        $sql = sprintf(
            'INSERT INTO business (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'description':
                        ...
                        break;
                    case 'sector':
                        $stmt->bindValue($identifier, $this->sector, PDO::PARAM_STR);
    ...
    {
        $pos = BusinessTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Business'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['Business'][$this->hashCode()] = true;
        $keys = BusinessTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getBusinessId(),
            $keys[1] => $this->getUserId(),
            $keys[2] => $this->getName(),
            $keys[3] => $this->getDescription(),
            $keys[4] => $this->getSector(),
        ];
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(BusinessTableMap::COL_BUSINESS_ID)) {
            $criteria->add(BusinessTableMap::COL_BUSINESS_ID, $this->business_id);
        }
        if ($this->isColumnModified(BusinessTableMap::COL_USER_ID)) {
            $criteria->add(BusinessTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(BusinessTableMap::COL_NAME)) {
            $criteria->add(BusinessTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(BusinessTableMap::COL_DESCRIPTION)) {
            $criteria->add(BusinessTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(BusinessTableMap::COL_SECTOR)) {
            $criteria->add(BusinessTableMap::COL_SECTOR, $this->sector);
        }
    ...
    {
        $criteria = ChildBusinessQuery::create();
        $criteria->add(BusinessTableMap::COL_BUSINESS_ID, $this->business_id);
    ...
    {
        $validPk = null !== $this->getBusinessId();
    ...
    /**
     * Generic method to set the primary key (business_id column).
     *
    ...
    {
        return null === $this->getBusinessId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \App\Propel\Business (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setBusinessId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Propel\Business Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * If this ChildBusiness is new, it will return
        ...
        if (null === $this->collProducts || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collProducts) {
                    ...
                    $collProducts->setModel('\App\Propel\Product');
    ...
    public function setProducts(Collection $products, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($productsToDelete as $productRemoved) {
            $productRemoved->setBusiness(null);
        }
     ...
     */
    protected function doAddProduct(ChildProduct $product): void
    {
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildProduct}> List of ChildProduct objects
     */
    public function getProductsJoinProductCategory(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildProductQuery::create(null, $criteria);
        $query->joinWith('ProductCategory', $joinBehavior);
    ...
    {
        if (null !== $this->aUser) {
            $this->aUser->removeBusiness($this);
        }
    ...
    {
        return (string) $this->exportTo(BusinessTableMap::DEFAULT_STRING_FORMAT);
    }
