...
abstract class Address implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\App\\Propel\\Map\\AddressTableMap';
    ...
    /**
     * Initializes internal state of App\Propel\Base\Address object.
     */
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[AddressTableMap::COL_USER_ID] = true;
        }
    ...
    public function setStreet($v)
    {
        ...
        if ($this->street !== $v) {
            $this->street = $v;
            $this->modifiedColumns[AddressTableMap::COL_STREET] = true;
        }
    ...
    public function setPostalCode($v)
    {
        ...
        if ($this->postal_code !== $v) {
            $this->postal_code = $v;
            $this->modifiedColumns[AddressTableMap::COL_POSTAL_CODE] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AddressTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AddressTableMap::translateFieldName('Street', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AddressTableMap::translateFieldName('City', TableMap::TYPE_PHPNAME, $indexType)];
            $this->city = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AddressTableMap::translateFieldName('PostalCode', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = AddressTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Propel\\Address'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(AddressTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }
        if ($this->isColumnModified(AddressTableMap::COL_STREET)) {
        ...
        if ($this->isColumnModified(AddressTableMap::COL_POSTAL_CODE)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(AddressTableMap::COL_USER_ID)) {
            $criteria->add(AddressTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(AddressTableMap::COL_STREET)) {
            $criteria->add(AddressTableMap::COL_STREET, $this->street);
        }
        if ($this->isColumnModified(AddressTableMap::COL_NUMBER)) {
        ...
        if ($this->isColumnModified(AddressTableMap::COL_POSTAL_CODE)) {
            $criteria->add(AddressTableMap::COL_POSTAL_CODE, $this->postal_code);
        }
    ...
    public function hashCode()
    {
        ...
        //relation fk__address_user to table user
     ...
     * objects.
     *
     * @param object $copyObj An object of \App\Propel\Address (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Propel\Address Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
