...
/**
 * Base class that represents a row from the 'product_category' table.
 *
 *
 *
...
abstract class ProductCategory implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\App\\Propel\\Map\\ProductCategoryTableMap';
    ...
    /**
     * Initializes internal state of App\Propel\Base\ProductCategory object.
     */
    ...
    /**
     * Compares this with another <code>ProductCategory</code> instance.  If
     * <code>obj</code> is an instance of <code>ProductCategory</code>, delegates to
     * <code>equals(ProductCategory)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setCategoryId($v)
    {
        ...
        if ($this->category_id !== $v) {
            $this->category_id = $v;
            $this->modifiedColumns[ProductCategoryTableMap::COL_CATEGORY_ID] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[ProductCategoryTableMap::COL_TITLE] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProductCategoryTableMap::translateFieldName('CategoryId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->category_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProductCategoryTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = ProductCategoryTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Propel\\ProductCategory'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(ProductCategoryTableMap::COL_CATEGORY_ID)) {
            $modifiedColumns[':p' . $index++]  = 'category_id';
        }
        if ($this->isColumnModified(ProductCategoryTableMap::COL_TITLE)) {
    ...
    {
        if (isset($alreadyDumpedObjects['ProductCategory'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['ProductCategory'][$this->hashCode()] = true;
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(ProductCategoryTableMap::COL_CATEGORY_ID)) {
            $criteria->add(ProductCategoryTableMap::COL_CATEGORY_ID, $this->category_id);
        }
        if ($this->isColumnModified(ProductCategoryTableMap::COL_TITLE)) {
            $criteria->add(ProductCategoryTableMap::COL_TITLE, $this->title);
        }
    ...
    {
        $criteria = ChildProductCategoryQuery::create();
        $criteria->add(ProductCategoryTableMap::COL_CATEGORY_ID, $this->category_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \App\Propel\ProductCategory (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Propel\ProductCategory Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * If this ChildProductCategory is new, it will return
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildProduct}> List of ChildProduct objects
     */
    public function getProductsJoinBusiness(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildProductQuery::create(null, $criteria);
        $query->joinWith('Business', $joinBehavior);
