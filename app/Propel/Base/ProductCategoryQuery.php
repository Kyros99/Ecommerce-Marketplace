...
use App\Propel\Map\ProductCategoryTableMap;
 ...
 * @method     ChildProductCategoryQuery orderByTitle($order = Criteria::ASC) Order by the title column
 *
 * @method     ChildProductCategoryQuery groupByCategoryId() Group by the category_id column
 * @method     ChildProductCategoryQuery groupByTitle() Group by the title column
 *
 ...
 *
 * @method     ChildProductCategoryQuery joinWithProduct($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Product relation
 *
 * @method     ChildProductCategoryQuery leftJoinWithProduct() Adds a LEFT JOIN clause and with to the query using the Product relation
 * @method     ChildProductCategoryQuery rightJoinWithProduct() Adds a RIGHT JOIN clause and with to the query using the Product relation
 * @method     ChildProductCategoryQuery innerJoinWithProduct() Adds a INNER JOIN clause and with to the query using the Product relation
 *
 * @method     \App\Propel\ProductQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildProductCategory|null findOneByCategoryId(int $category_id) Return the first ChildProductCategory filtered by the category_id column
 * @method     ChildProductCategory|null findOneByTitle(string $title) Return the first ChildProductCategory filtered by the title column
 *
 ...
 * @method     ChildProductCategory requireOneByTitle(string $title) Return the first ChildProductCategory filtered by the title column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 *
 * @method     ChildProductCategory[]|Collection findByCategoryId(int|array<int> $category_id) Return ChildProductCategory objects filtered by the category_id column
 * @psalm-method Collection&\Traversable<ChildProductCategory> findByCategoryId(int|array<int> $category_id) Return ChildProductCategory objects filtered by the category_id column
 * @method     ChildProductCategory[]|Collection findByTitle(string|array<string> $title) Return ChildProductCategory objects filtered by the title column
 * @psalm-method Collection&\Traversable<ChildProductCategory> findByTitle(string|array<string> $title) Return ChildProductCategory objects filtered by the title column
 *
...
abstract class ProductCategoryQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Propel\Base\ProductCategoryQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\Propel\\ProductCategory', $modelAlias = null)
    {
    ...
    public function findPk($key, ?ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = ProductCategoryTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
    ...
    {
        $sql = 'SELECT category_id, title FROM product_category WHERE category_id = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            ProductCategoryTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(ProductCategoryTableMap::COL_CATEGORY_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(ProductCategoryTableMap::COL_CATEGORY_ID, $keys, Criteria::IN);
    ...
    public function filterByCategoryId($categoryId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ProductCategoryTableMap::COL_CATEGORY_ID, $categoryId, $comparison);
    ...
    public function filterByTitle($title = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ProductCategoryTableMap::COL_TITLE, $title, $comparison);
    ...
    public function filterByProduct($product, ?string $comparison = null)
    {
        if ($product instanceof \App\Propel\Product) {
            $this
                ->addUsingAlias(ProductCategoryTableMap::COL_CATEGORY_ID, $product->getCategoryId(), $comparison);
    ...
    {
        if ($productCategory) {
            $this->addUsingAlias(ProductCategoryTableMap::COL_CATEGORY_ID, $productCategory->getCategoryId(), Criteria::NOT_EQUAL);
        }
