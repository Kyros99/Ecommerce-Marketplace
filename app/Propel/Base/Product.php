...
use App\Propel\ProductCategory as ChildProductCategory;
use App\Propel\ProductCategoryQuery as ChildProductCategoryQuery;
...
abstract class Product implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\App\\Propel\\Map\\ProductTableMap';
    ...
    /**
     * The value for the avg_review field.
     *
     * @var        string|null
     */
    protected $avg_review;
    ...
    /**
     * Get the [avg_review] column value.
     *
     * @return string|null
     */
    ...
    public function setBusinessId($v)
    {
        ...
        if ($this->business_id !== $v) {
            $this->business_id = $v;
            $this->modifiedColumns[ProductTableMap::COL_BUSINESS_ID] = true;
        }

        if ($this->aBusiness !== null && $this->aBusiness->getBusinessId() !== $v) {
            $this->aBusiness = null;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[ProductTableMap::COL_CODE] = true;
        }
    ...
    public function setShortDescription($v)
    {
        ...
        if ($this->short_description !== $v) {
            ...
            $this->modifiedColumns[ProductTableMap::COL_SHORT_DESCRIPTION] = true;
        }
    ...
    public function setLongDescription($v)
    {
        ...
        if ($this->long_description !== $v) {
            ...
            $this->modifiedColumns[ProductTableMap::COL_LONG_DESCRIPTION] = true;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[ProductTableMap::COL_AMOUNT] = true;
        }
    ...
    /**
     * Set the value of [avg_review] column.
     *
     * @param string|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setAvgReview($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->avg_review !== $v) {
            $this->avg_review = $v;
            $this->modifiedColumns[ProductTableMap::COL_AVG_REVIEW] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProductTableMap::translateFieldName('BusinessId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->business_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProductTableMap::translateFieldName('CategoryId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->category_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProductTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ProductTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ProductTableMap::translateFieldName('ShortDescription', TableMap::TYPE_PHPNAME, $indexType)];
            $this->short_description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ProductTableMap::translateFieldName('LongDescription', TableMap::TYPE_PHPNAME, $indexType)];
            $this->long_description = (null !== $col) ? (string) $col : null;
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ProductTableMap::translateFieldName('Amount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->amount = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ProductTableMap::translateFieldName('ImageUrl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->image_url = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ProductTableMap::translateFieldName('AvgReview', TableMap::TYPE_PHPNAME, $indexType)];
            $this->avg_review = (null !== $col) ? (string) $col : null;
    ...
    {
        if ($this->aBusiness !== null && $this->business_id !== $this->aBusiness->getBusinessId()) {
            $this->aBusiness = null;
        }
        if ($this->aProductCategory !== null && $this->category_id !== $this->aProductCategory->getCategoryId()) {
            $this->aProductCategory = null;
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_BUSINESS_ID)) {
            $modifiedColumns[':p' . $index++]  = 'business_id';
        }
        ...
        if ($this->isColumnModified(ProductTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(ProductTableMap::COL_SHORT_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'short_description';
        }
        if ($this->isColumnModified(ProductTableMap::COL_LONG_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'long_description';
        }
        if ($this->isColumnModified(ProductTableMap::COL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'price';
        }
        if ($this->isColumnModified(ProductTableMap::COL_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'amount';
        }
        if ($this->isColumnModified(ProductTableMap::COL_IMAGE_URL)) {
            $modifiedColumns[':p' . $index++]  = 'image_url';
        }
        if ($this->isColumnModified(ProductTableMap::COL_AVG_REVIEW)) {
            $modifiedColumns[':p' . $index++]  = 'avg_review';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'product_id':
                        ...
                        break;
                    case 'business_id':
                        $stmt->bindValue($identifier, $this->business_id, PDO::PARAM_INT);
                    ...
                    case 'image_url':
                        ...
                        break;
                    case 'avg_review':
                        $stmt->bindValue($identifier, $this->avg_review, PDO::PARAM_STR);
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[4] => $this->getCode(),
            $keys[5] => $this->getShortDescription(),
            $keys[6] => $this->getLongDescription(),
            $keys[7] => $this->getPrice(),
            $keys[8] => $this->getAmount(),
            $keys[9] => $this->getImageUrl(),
            $keys[10] => $this->getAvgReview(),
        ];
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aBusiness) {
                ...
                $result[$key] = $this->aBusiness->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aProductCategory) {
                ...
                $result[$key] = $this->aProductCategory->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setShortDescription($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setLongDescription($arr[$keys[6]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_BUSINESS_ID)) {
            $criteria->add(ProductTableMap::COL_BUSINESS_ID, $this->business_id);
        }
        if ($this->isColumnModified(ProductTableMap::COL_CATEGORY_ID)) {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_CODE)) {
            $criteria->add(ProductTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(ProductTableMap::COL_SHORT_DESCRIPTION)) {
            $criteria->add(ProductTableMap::COL_SHORT_DESCRIPTION, $this->short_description);
        }
        if ($this->isColumnModified(ProductTableMap::COL_LONG_DESCRIPTION)) {
            $criteria->add(ProductTableMap::COL_LONG_DESCRIPTION, $this->long_description);
        }
        if ($this->isColumnModified(ProductTableMap::COL_PRICE)) {
            $criteria->add(ProductTableMap::COL_PRICE, $this->price);
        }
        if ($this->isColumnModified(ProductTableMap::COL_AMOUNT)) {
            $criteria->add(ProductTableMap::COL_AMOUNT, $this->amount);
        }
        if ($this->isColumnModified(ProductTableMap::COL_IMAGE_URL)) {
            $criteria->add(ProductTableMap::COL_IMAGE_URL, $this->image_url);
        }
        if ($this->isColumnModified(ProductTableMap::COL_AVG_REVIEW)) {
            $criteria->add(ProductTableMap::COL_AVG_REVIEW, $this->avg_review);
        }
    ...
    {
        $copyObj->setBusinessId($this->getBusinessId());
        ...
        $copyObj->setAvgReview($this->getAvgReview());
    ...
    /**
     * Declares an association between this object and a ChildBusiness object.
     *
     * @param ChildBusiness $v
     * @return $this The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function setBusiness(ChildBusiness $v = null)
    {
        if ($v === null) {
            $this->setBusinessId(NULL);
        } else {
            $this->setBusinessId($v->getBusinessId());
        }

        $this->aBusiness = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildBusiness object, it will not be re-added.
        if ($v !== null) {
            $v->addProduct($this);
        }
    ...
    /**
     * Get the associated ChildBusiness object
     *
     * @param ConnectionInterface $con Optional Connection object.
     * @return ChildBusiness The associated ChildBusiness object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getBusiness(?ConnectionInterface $con = null)
    {
        if ($this->aBusiness === null && ($this->business_id != 0)) {
            $this->aBusiness = ChildBusinessQuery::create()->findPk($this->business_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBusiness->addProducts($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a ChildProductCategory object.
     *
     * @param ChildProductCategory $v
     * @return $this The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function setProductCategory(ChildProductCategory $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildProductCategory object, it will not be re-added.
        if ($v !== null) {
            $v->addProduct($this);
        }
    ...
    /**
     * Get the associated ChildProductCategory object
     *
     * @param ConnectionInterface $con Optional Connection object.
     * @return ChildProductCategory The associated ChildProductCategory object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getProductCategory(?ConnectionInterface $con = null)
    {
        if ($this->aProductCategory === null && ($this->category_id != 0)) {
            $this->aProductCategory = ChildProductCategoryQuery::create()->findPk($this->category_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
    ...
    public function setCartProducts(Collection $cartProducts, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($cartProductsToDelete as $cartProductRemoved) {
            $cartProductRemoved->setProduct(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildCartProduct}> List of ChildCartProduct objects
     */
    public function getCartProductsJoinUser(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCartProductQuery::create(null, $criteria);
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildOrderProduct}> List of ChildOrderProduct objects
     */
    public function getOrderProductsJoinOrders(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOrderProductQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aBusiness) {
            $this->aBusiness->removeProduct($this);
        }
        if (null !== $this->aProductCategory) {
            $this->aProductCategory->removeProduct($this);
        }
