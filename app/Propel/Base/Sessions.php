...
abstract class Sessions implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\App\\Propel\\Map\\SessionsTableMap';
    ...
    /**
     * Initializes internal state of App\Propel\Base\Sessions object.
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SessionsTableMap::COL_ID] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[SessionsTableMap::COL_USER_ID] = true;
        }
    ...
    public function setIpAddress($v)
    {
        ...
        if ($this->ip_address !== $v) {
            $this->ip_address = $v;
            $this->modifiedColumns[SessionsTableMap::COL_IP_ADDRESS] = true;
        }
    ...
    public function setUserAgent($v)
    {
        ...
        if ($this->user_agent !== $v) {
            $this->user_agent = $v;
            $this->modifiedColumns[SessionsTableMap::COL_USER_AGENT] = true;
        }
    ...
    public function setPayload($v)
    {
        ...
        if ($this->payload !== $v) {
            $this->payload = $v;
            $this->modifiedColumns[SessionsTableMap::COL_PAYLOAD] = true;
        }
    ...
    public function setLastActivity($v)
    {
        ...
        if ($this->last_activity !== $v) {
            ...
            $this->modifiedColumns[SessionsTableMap::COL_LAST_ACTIVITY] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SessionsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SessionsTableMap::translateFieldName('IpAddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ip_address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SessionsTableMap::translateFieldName('UserAgent', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_agent = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SessionsTableMap::translateFieldName('Payload', TableMap::TYPE_PHPNAME, $indexType)];
            $this->payload = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SessionsTableMap::translateFieldName('LastActivity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->last_activity = (null !== $col) ? (int) $col : null;
            ...
            return $startcol + 6; // 6 = SessionsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Propel\\Sessions'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(SessionsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(SessionsTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }
        if ($this->isColumnModified(SessionsTableMap::COL_IP_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'ip_address';
        }
        if ($this->isColumnModified(SessionsTableMap::COL_USER_AGENT)) {
            $modifiedColumns[':p' . $index++]  = 'user_agent';
        }
        if ($this->isColumnModified(SessionsTableMap::COL_PAYLOAD)) {
            $modifiedColumns[':p' . $index++]  = 'payload';
        }
        if ($this->isColumnModified(SessionsTableMap::COL_LAST_ACTIVITY)) {
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setPayload($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setLastActivity($arr[$keys[5]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(SessionsTableMap::COL_ID)) {
            $criteria->add(SessionsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(SessionsTableMap::COL_USER_ID)) {
            $criteria->add(SessionsTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(SessionsTableMap::COL_IP_ADDRESS)) {
            $criteria->add(SessionsTableMap::COL_IP_ADDRESS, $this->ip_address);
        }
        if ($this->isColumnModified(SessionsTableMap::COL_USER_AGENT)) {
            $criteria->add(SessionsTableMap::COL_USER_AGENT, $this->user_agent);
        }
        if ($this->isColumnModified(SessionsTableMap::COL_PAYLOAD)) {
            $criteria->add(SessionsTableMap::COL_PAYLOAD, $this->payload);
        }
        if ($this->isColumnModified(SessionsTableMap::COL_LAST_ACTIVITY)) {
            $criteria->add(SessionsTableMap::COL_LAST_ACTIVITY, $this->last_activity);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \App\Propel\Sessions (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Propel\Sessions Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
